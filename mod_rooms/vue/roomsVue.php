...
class RoomsVue
{
    ...
    public function genererAffichageRooms($valeurs){


        $this->chargementValeurs();

        $this->tpl->assign('titrePage', 'Liste des Chambres');

        $this->tpl->assign('listeRooms', $valeurs);

        $this->tpl->display('mod_rooms/vue/RoomListeVue.tpl');
    }
    ...
    public function genererAffichageFiche($valeurs, $action){
        ...
        $this->tpl->assign('uneRoom', $valeurs);
        ...
        $this->tpl->display('mod_rooms/vue/roomFicheVue.tpl');
